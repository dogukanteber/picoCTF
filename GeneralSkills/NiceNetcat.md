Copy and paste the netcat command to your terminal. Wait for a few seconds to see the output. They seem ascii. Adjust them to be seperated by a space which looks like this:
